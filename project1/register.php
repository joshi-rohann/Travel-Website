<section class="vh-100 bg-image"
  style="background-image: url('images/anna.jpg');"
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="action.php" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cdg" class="form-control form-control-lg" name="repass" />
                ...
                <div class="d-flex justify-content-center">
                  <a>
                  <button type="submit"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="register">Register</button> </a>
                </div>
